...
<html lang="en">
                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      @guest
                            <li><a href="/register"><span class="btn btn-outline-primary py-3 px-4">Register</span></a>
                             
                            </li>
                            @if (Route::has('register'))
                            <li><a href="/login"><span class="btn btn-outline-primary py-3 px-4">Login</span></a></li>
                            @endif
                      @else
                      <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();"><span class="bg-primary text-white py-3 px-4 rounded">Logout</span></a></li>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <h3 class="footer-heading mb-4 text-white">Categories</h3>
                  <ul class="list-unstyled">
                   @foreach ($categories_layout as $category)
  ...
  <script src="{{asset('js/jquery-ui.j')}}s"></script>
